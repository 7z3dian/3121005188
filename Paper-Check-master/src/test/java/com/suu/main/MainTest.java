package com.suu.main;

import com.suu.utils.HammingUtils;
import com.suu.utils.IOUtils;
import com.suu.utils.SimHashUtils;
...
public class MainTest {
    ...
    public void origAndOrigTest(){
        String str0 = IOUtils.read("D:/test/orig.txt");
        String str1 = IOUtils.read("D:/test/orig.txt");
    ...
    public void origAndAddTest(){
        String str0 = IOUtils.read("D:/test/orig.txt");
        String str1 = IOUtils.read("D:/test/orig_0.8_add.txt");
    ...
    public void origAndDelTest(){
        String str0 = IOUtils.read("D:/test/orig.txt");
        String str1 = IOUtils.read("D:/test/orig_0.8_del.txt");
    ...
    public void origAndDis1Test(){
        String str0 = IOUtils.read("D:/test/orig.txt");
        String str1 = IOUtils.read("D:/test/orig_0.8_dis_1.txt");
    ...
    public void origAndDis10Test(){
        String str0 = IOUtils.read("D:/test/orig.txt");
        String str1 = IOUtils.read("D:/test/orig_0.8_dis_10.txt");
    ...
    public void origAndDis15Test(){
        String str0 = IOUtils.read("D:/test/orig.txt");
        String str1 = IOUtils.read("D:/test/orig_0.8_dis_15.txt");
